    ...
    public class CinemachineTransposer : CinemachineComponentBase
    {
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            {   
                ...
                if (LookRotFwd)
                {   
                    orient = Quaternion.LookRotation(  (LookRotFwd.transform.position - FollowTarget.transform.position).normalized,Vector3.up   );
                }

                offset = orient * offset;
                Debug.DrawRay( transform.transform.position,offset * 10,Color.blue );
        ...
        public Quaternion GetReferenceOrientation(Vector3 worldUp)
        {
            ...
            if (FollowTarget != null)
            {
                ...
                switch (m_BindingMode)
                {
                    ...
                    case BindingMode.SimpleFollowWithWorldUp:
                    {
                        //var tt = base.VirtualCamera.LookAt;
